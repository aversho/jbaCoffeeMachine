...
Instruction
-----------
Write a program that offers to buy one cup of coffee or to fill the resources or to take its money. At the same time, the program should calculate how many resources it has left. And also display the number of resources before and after purchase.
